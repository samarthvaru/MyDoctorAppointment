...
<div id="apDiv8">
  <table width="273" height="36" border="0">
    <tr>
      <td><div align="center">Patient Login</div><hr></td>
    </tr>
    <tr>
      <td><div class="AccordionPanelContent">
        <form id="form1" name="form1" method="post" action="p_logincheck.php">
          <table width="270" border="0">
            ...
            <tr>
              <td height="42" colspan="3"><div align="center"><a href="signup.php"><font color="#000066" style="font-size:16px;"><i><u>Need an account? Signup here.</u></i></font></a></div></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
          </table>
...
<div id="apDiv10">
  <div align="left">
    <p style="font-size:36px; height: 20px; color: #030;">Patient and Visitors</p><hr size="4px">
