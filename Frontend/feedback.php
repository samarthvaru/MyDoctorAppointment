...
<div id="apDiv1">
  ...
  <div id="apDiv14">
    <div id="copyright">
  <div class="wrapper">
    <p align="center" style="color:#000;">Copyright &copy; 2019 - All Rights Reserved - <a href="#" style="color:#000;">SV Hospital</a></p>
    <p align="center" style="color:#000;">Powered By SV Hospital</p>
    <br class="clear" />
  </div>
</div>
</div>
  <div id="apDiv3">
    <form name="feedback" method="post" action="f_comment.php">
      <table width="511" height="391" border="0">
        <tr>
          <td height="69"><div align="center">FEEDBACK FORM</div><hr></td>
        </tr>
        <tr>
          <td><p>Your Name:</p>
          <p>
        ...
        <tr>
          <td><div align="left">
            <input type="submit" name="Submit" id="button" value="Comment" onClick="return validate()">
